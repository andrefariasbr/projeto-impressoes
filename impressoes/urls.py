...
urlpatterns = [
    ...
    path('pedido/<int:pedido_id>/admin/', views.detalhar_pedido_admin, name='detalhar_pedido_admin'),
    path('pedido/<int:pedido_id>/professor/', views.detalhar_pedido_professor, name='detalhar_pedido_professor'),
